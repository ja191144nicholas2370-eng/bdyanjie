...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      'svc2.desc': '三步自测 → AI生成诊断报告 → 燕姐人工批注 + 15分钟语音解读。你买到的不是AI，是有人认真看了你的时间。',
      'svc2.btn': '立即使用',
      'svc3.tag': '￥1,500 – 3,000',
      'svc3.title': '10天IP定位+账号内容交付包',
      'svc3.desc': '定位做完，内容帮你出。燕姐亲自做10天账号内容交付：定位、选题、内容框架一次给全，拿到就能发。',
      'svc3.btn': '立即咨询',
      'svc4.tag': 'Offline',
    ...
    'zh-tw': {
      ...
      'svc1.tag': 'Free · 免費使用',
      'svc1.title': 'AI + IP 定位工具包',
      'svc1.desc': '我整理的AI+IP定位工具，拿去直接用。覺得有用就分享給朋友。',
      'svc1.btn': '獲取工具包',
      'svc2.tag': '¥500',
      'svc2.title': 'AI + IP 定位雷達',
      'svc2.desc': '三步自測 → AI生成診斷報告 → 燕姐人工批註 + 15分鐘語音解讀。你買到的不是AI，是有人認真看了你的時間。',
      'svc2.btn': '立即使用',
      'svc3.tag': '￥1,500 – 3,000',
      'svc3.title': '10天IP定位+帳號內容交付包',
      'svc3.desc': '定位做完，內容幫你出。燕姐親自做10天帳號內容交付：定位、選題、內容框架一次給全，拿到就能發。',
      'svc3.btn': '立即諮詢',
      'svc4.tag': 'Offline',
    ...
    en: {
      ...
      'svc1.desc': 'My curated AI + IP positioning tools — take them and use them directly. Share them if you find them helpful.',
      'svc1.btn': 'Get Toolkit',
      'svc2.tag': '¥500',
      'svc2.title': 'AI + IP Positioning Radar',
      'svc2.desc': "Three steps: self-assessment → AI diagnostic report → Yan's personal annotations + 15-min voice interpretation. What you get is not AI output, but someone who seriously read your story.",
      'svc2.btn': 'Start Now',
      'svc3.tag': '¥1,500 – 3,000',
      'svc3.title': '10-Day IP Positioning + Content Delivery Pack',
      'svc3.desc': 'Positioning done, content handled. Yan personally delivers 10 days of account content: positioning, topics, and content framework, ready to post.',
